...
rule_3 = ['allow', '192.168.20.0/24','192.168.20.1/24', '80', '17']
# rule_4
...
data_set_text = default_quota + rule_1_quota + rule_2_quota + rule_3_quota # before shuffle
train_set_text = default_quota + rule_1_quota + rule_2_quota + rule_3_quota # + rule_4_quota

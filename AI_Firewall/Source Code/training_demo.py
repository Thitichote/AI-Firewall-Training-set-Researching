...
#if random state is 10 it will not shuffle data
...
# input dim is number of field that used to calculate
model.add(Dense(units = 20, kernel_initializer = 'uniform', activation='relu',input_dim = 18))
...
while (True):
    ...
    print(y_test.tolist()[var])
    print(y_pred.tolist()[var][0])

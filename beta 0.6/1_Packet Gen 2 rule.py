...
rule_2 = ['deny', '192.168.0.0/16', '161.246.34.11/24', '80', '6']
# rule_3
# rule_4
...
data_set_text = rule_1_quota + rule_2_quota + default_quota
train_set_text = rule_1_quota + rule_2_quota + default_quota
